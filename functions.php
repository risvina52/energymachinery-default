<?php
	...
	$args_arr = (array) $args;
	$args_before = $args_arr['before'] ?? '';
	$args_link_before = $args_arr['link_before'] ?? '';
	$args_link_after = $args_arr['link_after'] ?? '';
	$args_after = $args_arr['after'] ?? '';
	...
	function starkers_script_enqueuer() {
		...
		wp_register_script( 'plugins', get_template_directory_uri().'/js/production.min.js', array( 'jquery' ), '2.4.34', true);
		wp_enqueue_script( 'plugins' );

		//Style.css - header
		wp_register_style( 'screen', get_stylesheet_directory_uri().'/style.css', '', '1.5.50', 'screen' );
        wp_enqueue_style( 'screen' );

		// Redesign Style
		wp_register_style( 'redesign-style', get_template_directory_uri().'/css/redesign-new.css', array('screen'), '1.0.0', 'all' );
		wp_enqueue_style( 'redesign-style' );
	}
