...
<!-- </div> -->
	...
	<?php elseif( get_row_layout() == 'hero_redesign' ): ?>
		<?php
		...
		$finder_label = get_sub_field( 'finder_label' );
		$dropdown_placeholder = get_sub_field( 'dropdown_placeholder' );
		$dropdown_links = get_sub_field( 'dropdown_links' );
		?>
		<?php if ( $hero_eyebrow || $hero_title || $hero_desc || $hero_video_url || $dropdown_links ) : ?>
				<section class="rh-hero">
    <!-- Video background layer -->
    <div class="rh-hero-video">
        <div class="rh-hero-video-frame">
    ...
    <div class="rh-hero-inner">
        <div class="rh-hero-content">
            <?php if ( $hero_eyebrow ) : ?>
                <span class="rh-hero-eyebrow"><?php echo esc_html( $hero_eyebrow ); ?></span>
            <?php endif; ?>
            <?php if ( $hero_title ) : ?>
                <h1 class="rh-hero-title"><?php echo nl2br( esc_html( $hero_title ) ); ?></h1>
            <?php endif; ?>
            <?php if ( $hero_desc ) : ?>
                <p class="rh-hero-desc"><?php echo esc_html( $hero_desc ); ?></p>
            <?php endif; ?>

            <?php if ( $dropdown_links || $finder_label || $dropdown_placeholder ) : ?>
            <div class="rh-hero-finder">
                <?php if ( $finder_label ) : ?>
                    <div class="rh-hero-finder-label"><?php echo esc_html( $finder_label ); ?></div>
                <?php endif; ?>
                <details class="rh-solution-dropdown">
                    <summary>
                        <span><?php echo esc_html( $dropdown_placeholder ?: "I'm Looking For" ); ?></span>
	...
	<?php elseif( get_row_layout() == 'products_offer_redesign' ): ?>
		<?php
		...
		?>
		<?php if ( $eyebrow || $title || $desc || $products ) : ?>
<section class="what-we-offer-section">
			<div class="inner-wrap-fullwidth">
				<div class="what-we-offer-header">
					...
					<?php endif; ?>
					<div class="what-we-offer-title-row">
						<?php if ( $title ) : ?>
							<h2><?php echo esc_html( $title ); ?></h2>
						<?php endif; ?>
						<?php if ( $see_all_link ) : 
							$link_url = $see_all_link['url'];
							$link_title = $see_all_link['title'];
							$link_target = $see_all_link['target'] ? $see_all_link['target'] : '_self';
						?>
							<a href="<?php echo esc_url( $link_url ); ?>" class="btn-see-all" target="<?php echo esc_attr( $link_target ); ?>">
								<?php echo esc_html( $link_title ); ?> 
								<span class="arrow"><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none"><path d="M0.833374 10.8333L5.83337 5.83331L0.833374 0.833313" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
							</a>
						<?php endif; ?>
					</div>
					<?php if ( $desc ) : ?>
						<p class="body-default"><?php echo esc_html( $desc ); ?></p>
					<?php endif; ?>
				</div>
				...
				<div class="what-we-offer-grid">
					<?php while ( have_rows('products') ) : the_row(); ?>
						...
						$p_is_photo = get_sub_field('is_photo');
						$p_link = get_sub_field('link');
						if ( $p_title || $p_image ) :
						?>
							<<?php echo $p_link ? 'a href="'.$p_link['url'].'"' : 'div'; ?> class="what-we-offer-item<?php echo $p_is_photo ? ' is-photo' : ''; ?>">
								<?php if ( $p_image ) : ?>
									<div class="what-we-offer-item-image">
										<img src="<?php echo esc_url( $p_image['url'] ); ?>" alt="<?php echo esc_attr( $p_image['alt'] ?: $p_title ); ?>">
										<?php if ( $p_desc ) : ?>
											<div class="what-we-offer-item-desc"><?php echo esc_html( $p_desc ); ?></div>
										<?php endif; ?>
									</div>
								<?php endif; ?>
								<?php if ( $p_title ) : ?>
									<div class="what-we-offer-item-title"><?php echo esc_html( $p_title ); ?></div>
								<?php endif; ?>
	...
	<?php elseif( get_row_layout() == 'services_support_redesign' ): ?>
		<?php
		$eyebrow = get_sub_field('eyebrow');
		$title   = get_sub_field('title');
		$desc    = get_sub_field('desc');
		...
		?>
		<?php if ( $eyebrow || $title || $desc || $services ) : ?>
		<section class="support-we-section">
			<div class="inner-wrap-fullwidth">
				<div class="what-we-offer-header">
					<?php if ( $eyebrow ) : ?>
						<span class="eyebrow"><?php echo esc_html( $eyebrow ); ?></span>
				...
				<div class="support-we-grid">
					<?php while ( have_rows('services') ) : the_row(); ?>
						<?php
						$s_title = get_sub_field('title');
						$s_desc  = get_sub_field('desc');
						$s_image = get_sub_field('image');
						$s_is_photo = get_sub_field('is_photo');
						$s_link = get_sub_field('link');
						if ( $s_title || $s_image ) :
						?>
							<<?php echo $s_link ? 'a href="'.$s_link['url'].'"' : 'div'; ?> class="what-we-offer-item<?php echo $s_is_photo ? ' is-photo' : ''; ?>">
								<?php if ( $s_image ) : ?>
									<div class="what-we-offer-item-image">
										<img src="<?php echo esc_url( $s_image['url'] ); ?>" alt="<?php echo esc_attr( $s_image['alt'] ?: $s_title ); ?>">
										<?php if ( $s_desc ) : ?>
											<div class="what-we-offer-item-desc"><?php echo esc_html( $s_desc ); ?></div>
										<?php endif; ?>
									</div>
								<?php endif; ?>
								<?php if ( $s_title ) : ?>
									<div class="what-we-offer-item-title"><?php echo esc_html( $s_title ); ?></div>
								<?php endif; ?>
	...
	<?php elseif( get_row_layout() == 'industries_serve_redesign' ): ?>
		<?php
		$eyebrow = get_sub_field('eyebrow');
		$title   = get_sub_field('title');
		$see_all_link = get_sub_field('see_all_link');
		...
		?>
		<?php if ( $eyebrow || $title || $industries ) : ?>
		<section class="we-serve-section">
			<div class="inner-wrap-fullwidth">
				<div class="we-serve-header">
					<?php if ( $eyebrow ) : ?>
						<span class="eyebrow"><?php echo esc_html( $eyebrow ); ?></span>
					<?php endif; ?>
					<div class="we-serve-title-row">
						<?php if ( $title ) : ?>
							<h2><?php echo esc_html( $title ); ?></h2>
						<?php endif; ?>
						<?php if ( $see_all_link ) : 
							...
							$link_target = $see_all_link['target'] ? $see_all_link['target'] : '_self';
						?>
							<a href="<?php echo esc_url( $link_url ); ?>" class="btn-see-all btn-white" target="<?php echo esc_attr( $link_target ); ?>">
								<?php echo esc_html( $link_title ); ?> 
								<span class="arrow"><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none"><path d="M0.833374 10.8333L5.83337 5.83331L0.833374 0.833313" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
							</a>
						<?php endif; ?>
				...
				<div class="we-serve-grid">
					<?php while ( have_rows('industries') ) : the_row(); ?>
						<?php
						$ind_title = get_sub_field('title');
						$ind_image = get_sub_field('image');
						$ind_icon  = get_sub_field('icon'); // legacy raw SVG fallback
						$ind_link = get_sub_field('link');
						if ( $ind_title || $ind_image || $ind_icon ) :
						?>
							<div class="we-serve-item">
								<?php if ( $ind_image ) : ?>
									<<?php echo $ind_link ? 'a href="'.$ind_link['url'].'"' : 'div'; ?> class="we-serve-item-icon">
										<img src="<?php echo esc_url( $ind_image['url'] ); ?>" alt="<?php echo esc_attr( $ind_image['alt'] ?: $ind_title ); ?>">
									<?php echo $ind_link ? '</a>' : '</div>'; ?>
								<?php elseif ( $ind_icon ) : ?>
									<<?php echo $ind_link ? 'a href="'.$ind_link['url'].'"' : 'div'; ?> class="we-serve-item-icon">
										<?php echo $ind_icon; // Outputting raw SVG ?>
									<?php echo $ind_link ? '</a>' : '</div>'; ?>
								<?php endif; ?>
								<?php if ( $ind_title ) : ?>
									<div class="we-serve-item-title"><?php echo esc_html( $ind_title ); ?></div>
								<?php endif; ?>
							</div>
						<?php endif; ?>
					<?php endwhile; ?>
	...
	<?php elseif( get_row_layout() == 'about_us_redesign' ): ?>
		<?php
		$eyebrow = get_sub_field('eyebrow');
		$title = get_sub_field('title');
		...
		?>
		<?php if ( $eyebrow || $title || $bold_text || $desc || $text_mobile || $stats || $video_src ) : ?>
	...
	<div class="inner-wrap-fullwidth">
		<div class="about-us-grid">
			<div class="about-us-content">
				...
				<div class="body-default">
				   <div class="text-desktop">
                        <?php if ( $bold_text ) : ?>
						<p class="bold-text"><?php echo esc_html( $bold_text ); ?></p>
					<?php endif; ?>
					<?php if ( $desc ) : ?>
					...
					<div class="text-mobile">
                        <?php if ( $text_mobile ) : ?>
						<p><?php echo esc_html( $text_mobile ); ?></p>
					   <?php endif; ?>
				   </div>
				</div>
				...
				?>
					...
					<div class="about-us-cta-row about-us-cta-row--desktop">
						<a href="<?php echo esc_url( $link_url ); ?>" class="btn-see-all" target="<?php echo esc_attr( $link_target ); ?>">
							<?php echo esc_html( $link_title ); ?>
							<span class="arrow"><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none"><path d="M0.833374 10.8333L5.83337 5.83331L0.833374 0.833313" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
						</a>
				...
				<?php if ( have_rows('stats') ) : ?>
					...
					<div class="about-us-stats-row">
						<?php while ( have_rows('stats') ) : the_row(); ?>
							...
							$s_lbl = get_sub_field('label');
							if ( $s_num || $s_lbl ) :
							?>
								<div class="about-us-stat-item">
									<?php if ( $s_num ) : ?><div class="stat-number"><?php echo esc_html( $s_num ); ?></div><?php endif; ?>
									<?php if ( $s_lbl ) : ?><div class="stat-label"><?php echo esc_html( $s_lbl ); ?></div><?php endif; ?>
								</div>
							<?php endif; ?>
						<?php endwhile; ?>
					</div>
			...
			<?php if ( $cta_link ) : ?>
				...
				<div class="about-us-cta-row about-us-cta-row--mobile">
					<a href="<?php echo esc_url( $link_url ); ?>" class="btn-see-all" target="<?php echo esc_attr( $link_target ); ?>">
						<?php echo esc_html( $link_title ); ?>
						<span class="arrow"><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none"><path d="M0.833374 10.8333L5.83337 5.83331L0.833374 0.833313" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
					</a>
	...
	<?php elseif( get_row_layout() == 'learning_hub_redesign' ): ?>
		<?php
		$eyebrow = get_sub_field('eyebrow');
		$title = get_sub_field('title');
		$desc = get_sub_field('desc');
		...
		$featured_cta = get_sub_field('featured_cta');
		// Reusable arrow icon
		$lh_arrow = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h15M13 6l6 6-6 6"/></svg>';
		?>
		<?php if ( $eyebrow || $title || $desc || $featured_title || have_rows('items') ) : ?>
		<section class="learning-hub-section">
			<div class="inner-wrap-fullwidth">
				<div class="learning-hub-header">
					<div class="learning-hub-intro">
				...
				<div class="learning-hub-body">
					<div class="learning-hub-grid">

						<!-- Featured card -->
						<?php if ( $featured_title || $featured_image ) : ?>
						<div class="learning-hub-featured">
							<?php if ( $featured_image ) : ?>
								<div class="learning-hub-featured-media">
									<img src="<?php echo esc_url( $featured_image['url'] ); ?>" alt="<?php echo esc_attr( $featured_image['alt'] ?: $featured_title ); ?>">
								</div>
							<?php endif; ?>
							<div class="learning-hub-featured-overlay">
								<?php if ( $featured_title ) : ?><h3 class="learning-hub-featured-title"><?php echo esc_html( $featured_title ); ?></h3><?php endif; ?>
								<?php if ( $featured_desc ) : ?><p class="learning-hub-featured-desc"><?php echo esc_html( $featured_desc ); ?></p><?php endif; ?>
								<?php if ( $featured_cta ) : 
									$link_url = $featured_cta['url'];
									$link_title = $featured_cta['title'];
									$link_target = $featured_cta['target'] ? $featured_cta['target'] : '_self';
								?>
									<a href="<?php echo esc_url( $link_url ); ?>" class="learning-hub-link learning-hub-link--light" target="<?php echo esc_attr($link_target); ?>">
										<?php echo esc_html( $link_title ); ?>
										<?php echo $lh_arrow; ?>
									</a>
								<?php endif; ?>
						...
						<div class="learning-hub-list">
							<?php $index = 0; while ( have_rows('items') ) : the_row(); ?>
								<?php 
								$i_label = get_sub_field('label');
								$i_title = get_sub_field('title');
								$i_desc  = get_sub_field('desc');
								$i_cta   = get_sub_field('cta');
								if ( $i_title || $i_desc ) :
								?>
									<?php if ( $index > 0 ) : ?>
										<hr class="learning-hub-divider">
									<?php endif; ?>
									<div class="learning-hub-item">
										<?php if ( $i_label ) : ?><span class="learning-hub-item-label"><?php echo esc_html( $i_label ); ?></span><?php endif; ?>
										<?php if ( $i_title ) : ?><h3 class="learning-hub-item-title"><?php echo esc_html( $i_title ); ?></h3><?php endif; ?>
										<?php if ( $i_desc ) : ?><p class="learning-hub-item-desc"><?php echo esc_html( $i_desc ); ?></p><?php endif; ?>
										<?php if ( $i_cta ) : 
											$link_url = $i_cta['url'];
											$link_title = $i_cta['title'];
											$link_target = $i_cta['target'] ? $i_cta['target'] : '_self';
										?>
											<a href="<?php echo esc_url( $link_url ); ?>" class="learning-hub-link" target="<?php echo esc_attr($link_target); ?>">
												<?php echo esc_html( $link_title ); ?>
												<?php echo $lh_arrow; ?>
											</a>
										<?php endif; ?>
			...
			<?php if ( $cta_link ) : 
				...
				$link_target = $cta_link['target'] ? $cta_link['target'] : '_self';
			?>
				<a href="<?php echo esc_url( $link_url ); ?>" class="btn-see-all learning-hub-cta-mobile" target="<?php echo esc_attr($link_target); ?>">
					<?php echo esc_html( $link_title ); ?>
					<span class="arrow"><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none"><path d="M0.833374 10.8333L5.83337 5.83331L0.833374 0.833313" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
				</a>
			<?php endif; ?>
	...
	<?php elseif( get_row_layout() == 'partners_redesign' ): ?>
		<?php
		$title = get_sub_field('title');
		$bg_image = get_sub_field('bg_image');
		$partners = get_sub_field('partners');
		?>
		<?php if ( $title || $partners ) : ?>
		<section class="partners-section">
			<?php if ( $bg_image ) : ?>
				<img class="partners-bg" src="<?php echo esc_url( $bg_image['url'] ); ?>" alt="" aria-hidden="true">
			<?php endif; ?>
			<div class="inner-wrap-fullwidth">
				<div class="partners-row">
					<?php if ( $title ) : ?>
							...
							<?php while ( have_rows('partners') ) : the_row(); ?>
								...
								?>
									<div class="partners-logo">
										<img src="<?php echo esc_url( $p_logo['url'] ); ?>" alt="<?php echo esc_attr( $p_name ?: $p_logo['title'] ); ?>">
									</div>
								<?php endif; ?>
							<?php endwhile; ?>
						</div>
	...
	<?php elseif( get_row_layout() == 'contact_cta_redesign' ): ?>
		<?php
		$bg_image = get_sub_field('bg_image');
		$eyebrow  = get_sub_field('eyebrow');
		$title    = get_sub_field('title');
		...
		$contact_arrow = '<svg class="cta-arrow" xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none"><path d="M0.833374 10.8333L5.83337 5.83331L0.833374 0.833313" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/></svg>';
		?>
		<?php if ( $title || $form_shortcode || $phone || $email ) : ?>
		<section class="contact-cta-section">
			<!-- Background image + dark overlay span the whole section -->
			<?php if ( $bg_image ) : ?>
				<img class="contact-cta-bg" src="<?php echo esc_url( $bg_image['url'] ); ?>" alt="" aria-hidden="true">
			<?php endif; ?>
			<div class="contact-cta-overlay" aria-hidden="true"></div>

			<!-- Left: info panel -->
			<div class="contact-cta-info">
				<div class="contact-cta-info-inner">
					<div class="contact-cta-info-top">
						<div class="contact-cta-heading">
							<?php if ( $eyebrow ) : ?><span class="eyebrow"><?php echo esc_html( $eyebrow ); ?></span><?php endif; ?>
							<?php if ( $title ) : ?><h2><?php echo esc_html( $title ); ?></h2><?php endif; ?>
						</div>
						<?php if ( $desc ) : ?><p class="contact-cta-text"><?php echo esc_html( $desc ); ?></p><?php endif; ?>
						<?php if ( $cta_link ) : 
							$link_url = $cta_link['url'];
							$link_title = $cta_link['title'];
							$link_target = $cta_link['target'] ? $cta_link['target'] : '_self';
						?>
							<a href="<?php echo esc_url( $link_url ); ?>" class="contact-cta-btn btn-see-all" target="<?php echo esc_attr($link_target); ?>">
								<?php echo esc_html( $link_title ); ?>
								<?php echo $contact_arrow; ?>
							</a>
						<?php endif; ?>
					</div>

					<div class="contact-cta-info-bottom">
						<?php if ( $phone ) : ?>
							<hr class="contact-cta-divider">
							<div class="contact-cta-contact-row">
								<span class="contact-cta-label eyebrow">Call Us</span>
								<a class="contact-cta-value" href="tel:<?php echo esc_attr( $phone_tel ); ?>"><?php echo esc_html( $phone ); ?></a>
							</div>
						<?php endif; ?>
						<?php if ( $email ) : ?>
							<hr class="contact-cta-divider">
							<div class="contact-cta-contact-row">
								<span class="contact-cta-label eyebrow">Email Us</span>
								<a class="contact-cta-value" href="mailto:<?php echo esc_attr( $email ); ?>"><?php echo esc_html( $email ); ?></a>
							</div>
						<?php endif; ?>
					</div>
				</div>
